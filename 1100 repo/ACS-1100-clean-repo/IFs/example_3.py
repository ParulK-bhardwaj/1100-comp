...
print(12 > 13 and 13 > 12) #False

print(14 < 15 and 0 == 0) #True

print(15 - 10 < 6 and 6 <= 6) #True

print(1 / 3 and 1 < 0) #False

print("a" in "Hello" and "W" in "World") #False

print("o" in "Hello World" and "oo" in "Foo Bar") #True

print("April" in "April 1" and "Oct." in "October 31") #False
